...
def get_args():
    parser = argparse.ArgumentParser(
        description="Score-based VE-SDE model on MNIST (train only)"
    )
...
def main(args):
    ...
    # Optionnel : test set au cas où tu veuilles l'utiliser plus tard
    ...
    print("MNIST test size :", len(test_data))
    ...
    in_ch = 1  # MNIST: images en niveaux de gris
